...
<div class="nav w1210 bc mt10">
    ...
    <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
        ...
        <div class="cat_bd">
            ...
            <?php echo \frontend\widgets\CategoryWidget::widget();
...
<div class="colligate w1210 bc mt10">
    ...
    <div class="slide fl">
        <div class="area">
            <div class="slide_items">
                <ul>
                    <?=Html::img('@web/images/index_slide1.jpg',['title'=>'京西商城'])?>
                    <?=Html::img('@web/images/index_slide2.jpg',['title'=>'京西商城'])?>
                    <?=Html::img('@web/images/index_slide3.jpg',['title'=>'京西商城'])?>
                    <?=Html::img('@web/images/index_slide4.jpg',['title'=>'京西商城'])?>
                    <?=Html::img('@web/images/index_slide5.jpg',['title'=>'京西商城'])?>
                    <?=Html::img('@web/images/index_slide6.jpg',['title'=>'京西商城'])?>
                </ul>
            </div>
    ...
    <div class="coll_right fl ml10">
        <div class="ad"><a href=""><?=Html::img('@web/images/ad.jpg',['title'=>'京西商城'])?></a></div>
        ...
        <div class="service mt10">
            ...
            <div class="service_wrap">
                ...
                <div class="travel none">
                    <ul>
                        <li>
                            <?=Html::img('@web/images/holiday.jpg',['title'=>'京西商城'])?>
                            <a href="" class="button">度假查询</a>
                        </li>
                        <li>
                            <?=Html::img('@web/images/scenic.jpg',['title'=>'京西商城'])?>
                ...
                <div class="lottery none">
                    <p><?=Html::img('@web/images/lottery.jpg',['title'=>'京西商城'])?></p>
                </div>
                <!-- 彩票 end -->
                ...
                <div class="game none">
                    <ul>
                        <?=Html::img('@web/images/sanguo.jpg',['title'=>'京西商城'])?>
                        <?=Html::img('@web/images/taohua.jpg',['title'=>'京西商城'])?>
                        <?=Html::img('@web/images/wulin.jpg',['title'=>'京西商城'])?>
                    </ul>
                </div>
                <!-- 游戏 end -->
            </div>
...
<div class="guide w1210 bc mt15">
        ...
        <div class="guide_wrap">
            ...
            <div class="crazy">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/crazy1.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/crazy2.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/crazy3.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/crazy4.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/crazy5.jpg',['title'=>'京西商城'])?></a></dt>
            ...
            <div class="hot none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/hot1.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/hot2.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/hot3.jpg',['title'=>'京西商城'])?></a></dt>
            ...
            <div class="recommend none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/recommend1.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><a href=""><?=\yii\helpers\Html::img('@web/images/recommend2.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><a href=""><?=\yii\helpers\Html::img('@web/images/recommend3.jpg',['title'=>'京西商城'])?></a></dt>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="sidebar_wrap">
            <dl class="first">
                <dt class="fl"><a href=""><a href=""><?=\yii\helpers\Html::img('@web/images/viewsonic.jpg',['title'=>'京西商城'])?></a></dt>
            ...
            <dl>
                <dt class="fr"><a href=""><?=\yii\helpers\Html::img('@web/images/samsung.jpg',['title'=>'京西商城'])?></a></dt>
...
<div class="floor1 floor w1210 bc mt10">
    ...
    <div class="floor_left fl">
        ...
        <div class="cate fl">
            ...
            <div class="cate_wrap">
                ...
                <p><a href=""><?=\yii\helpers\Html::img('@web/images/notebook.jpg',['title'=>'京西商城'])?></a></p>
            </div>
            ...
            <div class="goodslist_wrap">
                <div>
                    <ul>
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/hpG4.jpg',['title'=>'京西商城'])?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/thinkpad e420.jpg',['title'=>'京西商城'])?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/acer4739.jpg',['title'=>'京西商城'])?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/samsung6800.jpg',['title'=>'京西商城'])?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/lh531.jpg',['title'=>'京西商城'])?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/qinghuax2.jpg',['title'=>'京西商城'])?></a></dt>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="brand">
            ...
            <div class="sidebar_wrap">
                <ul>
                    <?=\yii\helpers\Html::img('@web/images/dell.gif',['title'=>'京西商城'])?>
                    <?=\yii\helpers\Html::img('@web/images/acer.gif',['title'=>'京西商城'])?>
                    <?=\yii\helpers\Html::img('@web/images/hp.jpg',['title'=>'京西商城'])?>
                    <?=\yii\helpers\Html::img('@web/images/lenove.jpg',['title'=>'京西商城'])?>
                    <?=\yii\helpers\Html::img('@web/images/samsung.gif',['title'=>'京西商城'])?>
                    <?=\yii\helpers\Html::img('@web/images/samsung.gif',['title'=>'京西商城'])?>
                    <?=\yii\helpers\Html::img('@web/images/dlink.gif',['title'=>'京西商城'])?>
                    <?=\yii\helpers\Html::img('@web/images/seagate.jpg',['title'=>'京西商城'])?>
                    <?=\yii\helpers\Html::img('@web/images/intel.jpg',['title'=>'京西商城'])?>
                </ul>
            </div>
        </div>
        <!-- 品牌旗舰店 end -->
        ...
        <div class="ads mt10">
            <a href="">
                <?=\yii\helpers\Html::img('@web/images/canon.jpg',['title'=>'京西商城'])?></a>
        </div>
        <!-- 广告 end -->
    </div>
    <!-- 右侧 end -->
