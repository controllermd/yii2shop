...
<div class="list w1210 bc mt10">
    ...
    <div class="list_left fl mt10">
        ...
        <div class="newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot1.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot2.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/list_hot3.jpg',['title'=>'京西商城'])?></a></dt>
        ...
        <div class="viewd leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <dl>
                    <dt><a href=""><a href=""><?=\yii\helpers\Html::img('@web/images/hpG4.jpg',['title'=>'京西商城'])?></a></dt>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <!--显示不出来图片，因为www.yii2shop.com指向的位置是前台，所以要在前面家一个后台的地址才可以显示
                      -->
                        <dt><?=\yii\helpers\Html::a(\yii\helpers\Html::img('http://admin.yii2shop.com'.$model->logo,['goods/goods','id'=>$model->id],['title'=>'京西商城']))?></dt>
                        <dd><?=\yii\helpers\Html::a($model->name,['goods/goods','id'=>$model->id])?></dd>
