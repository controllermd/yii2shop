        ...
        <div class="related_view newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/relate_view1.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/relate_view2.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/relate_view3.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/relate_view4.jpg',['title'=>'京西商城'])?></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img('@web/images/relate_view5.jpg',['title'=>'京西商城'])?></a></dt>
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    ...
                    <a href="<?=\yii\helpers\Html::img('@web/images/preview_m1.jpg')?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <?=\yii\helpers\Html::img('http://admin.yii2shop.com'.$model->logo,['title'=>'京西商城'])?>
                        <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m2.jpg',largeimage: 'images/preview_l2.jpg'}"></a>
                            </li>
                            <?php foreach ($model->img as $img): ?>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'images/preview_m3.jpg',largeimage: 'images/preview_l3.jpg'}">
                                    <?=\yii\helpers\Html::img('http://admin.yii2shop.com'.$img->url,['title'=>'京西商城'])?></a>
                            </li>
                            <?php endforeach; ?>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['goods/catadd'])?>" method="post" class="choose">
                    <ul>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        ...
                        <?=\yii\helpers\Html::img('@web/images/desc1.jpg',['title'=>'京西商城'])?>
                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img('@web/images/desc2.jpg',['title'=>'京西商城'])?>
                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img('@web/images/desc3.jpg',['title'=>'京西商城'])?>
                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img('@web/images/desc4.jpg',['title'=>'京西商城'])?>
                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img('@web/images/desc5.jpg',['title'=>'京西商城'])?>
                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img('@web/images/desc6.jpg',['title'=>'京西商城'])?>
                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img('@web/images/desc7.jpg',['title'=>'京西商城'])?>
                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img('@web/images/desc8.jpg',['title'=>'京西商城'])?>
                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img('@web/images/desc9.jpg',['title'=>'京西商城'])?>
                    </div>
                </div>
                <!-- 商品介绍 end -->
                ...
                <div class="comment detail_div mt10">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/user1.gif',['title'=>'京西商城'])?></a></dt>
                                <dd><a href="">乖乖</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/user2.jpg',['title'=>'京西商城'])?></a></dt>
                                <dd><a href="">小宝贝</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/user3.jpg',['title'=>'京西商城'])?></a></dt>
                                <dd><a href="">天使</a></dd>
                            </dl>
                        </div>
                        <div class="item">
